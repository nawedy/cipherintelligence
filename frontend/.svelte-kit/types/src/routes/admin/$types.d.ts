...
type LayoutRouteId = RouteId | "/admin" | "/admin/approvals" | "/admin/builder" | "/admin/content" | "/admin/editor" | "/admin/editor/[page_id]"
type LayoutParams = RouteParams & { page_id?: string }

...
type LayoutRouteId = RouteId | "/" | "/(auth)/signin" | "/(auth)/signup" | "/[...path]" | "/admin" | "/admin/approvals" | "/admin/builder" | "/admin/content" | "/admin/editor" | "/admin/editor/[page_id]" | "/login" | "/products" | "/products/[slug]" | "/research" | null
type LayoutParams = RouteParams & { path?: string; page_id?: string; slug?: string }
